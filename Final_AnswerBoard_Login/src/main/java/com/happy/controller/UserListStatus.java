...
@WebServlet("/UserListStatus")
public class UserListStatus extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private Logger logger = Logger.getLogger(UserListStatus.class);
    public UserListStatus() {
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HappyBoardPagingDto pg = new HappyBoardPagingDto(Integer.parseInt(rowSize), pageNo, uDao.countAllUser());
